...
#ifndef __SOCKET_INTERFACE_UNIX_H__
#define __SOCKET_INTERFACE_UNIX_H__
...
class UDPSocketInterfaceUnix {
public:
  UDPSocketInterfaceUnix();
...
class TCPSocketInterfaceUnix {
public:
  TCPSocketInterfaceUnix();
...
#endif //  __SOCKET_INTERFACE_UNIX_H__
