 ...
 */
#ifndef __LDLIDAR_DRIVER_SDK_UNIX_INTERFACE_H__
#define __LDLIDAR_DRIVER_SDK_UNIX_INTERFACE_H__
...
class LDLidarDriverUnixInterface : public LDLidarDriver {
public:
  LDLidarDriverUnixInterface();
  ...
  */
  ...
  static LDLidarDriverUnixInterface* Create(void) {
    LDLidarDriverUnixInterface* pdrv = new LDLidarDriverUnixInterface();
    return pdrv;
  }

  static void Destory(LDLidarDriverUnixInterface* pdrv) {
    if (pdrv != nullptr) {
      delete pdrv;
    }
  }
...
private:
  ...
  SerialInterfaceUnix* comm_serial_;
  TCPSocketInterfaceUnix* comm_tcp_network_;
  UDPSocketInterfaceUnix* comm_udp_network_;
