...
# that position will match. A partial path can also be specified to, for example_simple, exclude
...
meta:
	ADDON_NAME = ofxLDLidar
	ADDON_DESCRIPTION = LD LiDAR SDK wrapper for openFrameworks
	ADDON_AUTHOR = @Eotel
	ADDON_TAGS = "LiDAR"
	ADDON_URL = https://github.com/Eotel/ofxLDLidar

common:
	ADDON_INCLUDES_exclude = libs/ldlidar/src/arch%
	...
	# 
	# For example_simple in the ofxOpenCV addon we do something like this:
	#
	# ADDON_LIBS =
